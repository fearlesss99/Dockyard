...
TC-13.26a**; runtime is **Current — TC-13.26b** and E2E verification is
**Verified — TC-13.26c**. The explicit
`start_admitted_dispatch_execution` entry adopts an existing canonical
