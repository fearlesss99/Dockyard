...
class GateInStateLockTests(unittest.TestCase):
    """TC-13.12c.2 — Gate must be called while _exclusive_state_lock is held.

    NOT mocked: _exclusive_state_lock, OS advisory lock.
    NOT using time.sleep.
    """
    # Moved to test_control_plane_transition.py where apply_transition
    # and the real worker-slot-lease harness exist.
    pass
